...
You can use this library to access Bulk API functions. Batch sizes can be declared using the batchsize argument. Default is 10,000 records. Batch sizes are only supported in the following methods: insert,upsert,update,delete,hard_delete.
