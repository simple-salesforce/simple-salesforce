...
from simple_salesforce.util import date_to_iso8601, exception_handler, getUniqueElementValueFromXmlString
...
class TestXMLParser(unittest.TestCase):
    ...
    def test_returns_valid_value(self):
        ...
        result = getUniqueElementValueFromXmlString('<?xml version="1.0" encoding="UTF-8"?><foo>bar</foo>', "foo")
    ...
    def test_date_to_iso8601(self):
        ...
        date = pytz.timezone("America/Phoenix").localize(datetime.datetime(2014, 3, 22, 00, 00, 00, 0))
        result = date_to_iso8601(date)
...
class TestExceptionHandler(unittest.TestCase):
    ...
    def test_multiple_records_returned(self):
        ...
        self.assertEqual(
            str(cm.exception),
            ("More than one record for " "http://www.example.com/. Response content: Example Content"),
        )
    ...
    def test_malformed_request(self):
        ...
        self.assertEqual(
            str(cm.exception), ("Malformed request " "http://www.example.com/. Response content: Example Content")
        )
    ...
    def test_expired_session(self):
        ...
        self.assertEqual(
            str(cm.exception), ("Expired session for " "http://www.example.com/. Response content: Example Content")
        )
    ...
    def test_request_refused(self):
        ...
        self.assertEqual(
            str(cm.exception), ("Request refused for " "http://www.example.com/. Response content: Example Content")
        )
    ...
    def test_resource_not_found(self):
        ...
        self.assertEqual(
            str(cm.exception), ("Resource SpecialContacts Not" " Found. Response content: Example Content")
        )
    ...
    def test_generic_error_code(self):
        ...
        self.assertEqual(str(cm.exception), ("Error Code 500. Response content" ": Example Content"))
