""" Classes for interacting with Salesforce Tableau CRM / Einstein Analytics / Wave Analytics API """
...
class TableauCRMHandler:
    """
    Tableau CRM / Einstein Analytics / Wave Analytics API handler.
    """
    ...
    def __init__(self, headers, wave_url, proxies=None, session=None):
        ...
        * wave_url -- Wave Analytics/Einstein Analytics/Tableau CRM API endpoint set in Salesforce instance
